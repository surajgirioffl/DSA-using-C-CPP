 ...
 *1. swaping perform in inner for loop each time if condition is true.
 *2. swaping perform just after termination of inner loop.
 */
...
/*sorting using selection sort. By swaping outside the inner for loop.*/
...
/*sorting using selection sort. By swaping inside the inner for loop.*/
void selectionSort::algorithm2()
{
    for (int i = 0; i < size - 1; i++)
    {
        for (int j = i + 1; j < size; j++)
        {
            if (array[i] > array[j]) // performing swaping
            {
                int temp = array[i];
                array[i] = array[j];
                array[j] = temp;
...
int main()
{
    system("cls");
    selectionSort obj;
    cout << "Press 1 for sort the array via algorithm 1 of selection i.e swaping in inner loop." << endl;
    cout << "Press 2 for sort the array via algorithm 2 of selection i.e swaping outside of inner loop." << endl;
    int choice = 1;
    cout << "$ ";
    cin >> choice;
